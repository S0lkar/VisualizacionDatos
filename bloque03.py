...
fig = px.bar(B3_0X_filtered, x='Country of Operator/Owner', color='Purposes', text='Official Name of Satellite',
             title='Number of Satellites by Purpose for Each Country of Operator/Owner (Countries with >20 Satellites)',
